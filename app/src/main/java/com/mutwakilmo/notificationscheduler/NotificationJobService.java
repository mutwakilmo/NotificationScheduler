package com.mutwakilmo.notificationscheduler;
...
public class NotificationJobService extends JobService {
    ...
    public boolean onStopJob(JobParameters params) {
        //TODO Make sure that onStopJob() returns true, because if the job fails, you want the job to be rescheduled instead of dropped.
        return true;
    }
    ...
    public void createNotificationChannel(){
        ...
        //notification channel are only available in OREO and higher
        //So, add and check SDK  version
